export const SAMPLE_CONTRACTS = [
  {
    ...
    badge: '🚨 High Risk (Common Trap)',
    description: 'A standard consulting agreement containing aggressive IP assignment, uncapped indemnity, and a 24-month non-compete.',
...
Company may terminate this Agreement at any time without cause upon 24 hours written notice. In the event of termination, Contractor shall only be entitled to pro-rata payment for accepted deliverables.`
  ...
  {
    id: 'commercial-lease',
    name: 'Commercial Office / Retail Lease',
    badge: '⚠️ Moderate-to-High Risk',
    description: 'Tenancy agreement with 3-year automatic rollover, hidden triple-net CAM capital expenses, and rent acceleration upon late payment.',
...
All improvements, interior walls, electrical wiring, and fixtures installed by Tenant shall immediately become the permanent property of Landlord upon installation.`
  },
  {
    ...
    name: 'Creator & Influencer Brand Deal',
    badge: '🚨 High Risk (Perpetual AI Likeness Rights)',
    description: 'Sponsorship contract giving brand perpetual AI training rights to your face/voice, 1-year category lock, and performance pay withholdings.',
...
Any breach of exclusivity or negative commentary regarding Sponsor shall entitle Sponsor to liquidated damages in the amount of $25,000 plus return of all sponsorship fees.`
  },
  {
    ...
    badge: '✅ Low Risk (Fair & Mutual)',
    description: 'Standard bilateral NDA with clear trade secret definition, 2-year sunset clause, and balanced obligations.',
